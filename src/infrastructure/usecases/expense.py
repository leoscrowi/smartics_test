...
class ExpenseUsecase:
    ...
    def get(self, category_id: uuid.UUID) -> ExpenseEntity:
        return self.expense_repo.get(category_id)

    def get_user_categories(self, user_id: uuid.UUID) -> List[ExpenseEntity]:
        return self.expense_repo.get_user_categories(user_id)
    ...
    def delete(self, category_id: uuid.UUID):
        self.expense_repo.delete(category_id)
